...
language. However, in this case, there is only ever a single active instance of the class.
...
analogous to the `init` function of a class in a high-level language.

#### Compute Function

When this function is invoked, the computation process begins. The actual internal functionality is
specific to the specific computation. The function returns a flag indicating if the function was
successful.
