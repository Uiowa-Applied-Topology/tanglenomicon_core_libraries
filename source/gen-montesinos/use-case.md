...
- [Generator Interface](../../docs/use_cases/generators/interface.md)

## Uses

- [Twist Vector Notation](../note-twist_vector/use-case)
- [Algebraic Tangle Tree Notation](../note-algebraic_tangle_tree/use-case)
