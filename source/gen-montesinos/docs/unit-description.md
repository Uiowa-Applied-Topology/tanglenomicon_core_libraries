...
- [Twist Vector Notation][note-twist_vector]
- [Algebraic Tangle Tree Notation][note-algebraic_tangle_tree]
...
The process loop state function handles the construction and writing of an algebraic tangle tree in
