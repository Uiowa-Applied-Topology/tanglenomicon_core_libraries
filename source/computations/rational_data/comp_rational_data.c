...
/*!
 * @brief A private function that commits to storage the algebraic equivalence
...
/*!
 * @brief A private function that commits to storage the parity associated to
 * the configured tangle.
 *
 ...
 * configured tangle.
 *
 * @param p A pointer to the storage location for the numerator of the
 * configured tangle.
 * @param q A pointer to the storage location for the denominator of the
 * configured tangle.
 * @return uint8_t A condition code for the computation. Indicates failure mode
 * if any.
 */
...
/*!
 * @brief A private function that commits to storage the rational number
