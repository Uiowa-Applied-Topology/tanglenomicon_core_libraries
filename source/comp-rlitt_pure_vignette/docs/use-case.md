...
> [!theorem]
>
>    The pure vignette of an
>    [Right Leaning Identity Tangle Tree (RLITT)](https://thesis.joe-starr.com/tabulation/#subsec-rlitt)
>    is invariant.
>
> [!proof]
>
...
> rooted plane trees. Since RLITT are unique representatives of the isotopy class we have the
> desired result.
>
> [!example]
>
> ![Pure Vignette](./media/pure-vign.svg)
>
...
> [!example]
>
> ![Pure Stick](./media/pure-vign_stick.svg)
>
> On the top we find a rational tangle with its tree and linearization. On the bottom we find the
> rooted plane tree as well as the pure vignette associated with the tangle.
