...
static char *paths_d =
    "0,0,0\n0,1,1\n0,2,2\n0,3,3\n\n// a comment\n1,0,0\n1,1,1\n1,2,2\n\n2,0,0";
static note_plpath_t good_path = { &sp00, NULL, NULL };
/************************************************************************************************/
...
static void test_turn_around_test_ede(void)
{
    ...
    note_plpath_segment_buffer_t seg_buffer = { (note_plpath_segment_t *)&segments,
                                                UTIL_TANG_DEFS_MAX_CROSSINGNUM,
                                                0 };
    note_plpath_t                path = { NULL, &buffer, &seg_buffer };
    ...
    retval = note_plpath_encode(path, output_post, 1000);
    TEST_ASSERT_EQUAL(NOTE_DEFS_ENCODE_SUCCESS, retval);
...
{
    {
        ...
        note_plpath_t path_post = { NULL, &buffer, &seg_buffer };
