...
tangle[${}^{[2]}$][${}^{[1](https:
//doi.org/10.48550/arXiv.math/0212011)}$](https://doi.org/10.1016/B978-0-08-012975-4.50034-5). A
canonical combinatorial description of a rational tangle can be given by the
[Twist Vector][#note-twist_vector].
