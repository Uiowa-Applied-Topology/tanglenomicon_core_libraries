...
void test_encode_positive(void)
{
    ...
    RUN_TEST(test_encode_positive_tangle_5);
}
...
static void test_encode_positive_knot_1(void)
{
    ...
    retval = note_wptt_encode(note_wptt_valid, test_string, UTIL_TANG_DEFS_MAX_CROSSINGNUM * 10u);
...
/*
 * - A valid string representing a stick tangle.
 *
 */
