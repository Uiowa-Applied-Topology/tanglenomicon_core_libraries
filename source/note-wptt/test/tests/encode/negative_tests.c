...
void test_encode_negative_1()
{
    ...
    retval = note_wptt_encode(note_wptt, test_string, UTIL_TANG_DEFS_MAX_CROSSINGNUM * 10u);
...
void test_encode_negative_4()
{
    ...
    /* clang-format on */
    retval = note_wptt_encode(note_wptt, NULL, UTIL_TANG_DEFS_MAX_CROSSINGNUM * 10u);
    TEST_ASSERT_EQUAL(NOTE_DEFS_ENCODE_FAIL, 0x01u & retval);
}
