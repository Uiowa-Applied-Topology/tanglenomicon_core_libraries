...
tangles; rational number, parity, and algebraic equivalence of closures.
...
class of the numerator closure of the tangle. Equivalence is give by schubert
{cite:p}`Schubert1956` as:
