...
However, in this case, there is only ever a single active instance of the class.
...
specific to the specific generator. The function returns a flag indicating if the function was
successful.
